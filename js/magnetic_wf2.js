...
*/      
      COSHS1 = Cplx.multiply(2, Cplx.cosh(Cplx.multiply(S1, sld_L.thickness)));
      SINHS1 = Cplx.multiply(2, Cplx.sinh(Cplx.multiply(S1, sld_L.thickness)));
...
*/
      COSHS3 = Cplx.multiply(2, Cplx.cosh(Cplx.multiply(S3, sld_L.thickness)));
      SINHS3 = Cplx.multiply(2, Cplx.sinh(Cplx.multiply(S3, sld_L.thickness)));
